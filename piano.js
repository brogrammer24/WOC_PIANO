...
window.makeSound = function (key) {
    ...
    switch (key) {
        ...
        case "C1":
            var C1 = new Audio('notes/notes_C1.mp3');
            C1.play();
            break;
        case "D1":
            var D1 = new Audio('notes/notes_D1.mp3');
            D1.play();
            break;
        case "D1":
            var D1 = new Audio('notes/notes_D1.mp3');
            ...
            break;
        case "E1":
            var E1 = new Audio('notes/notes_E1.mp3');
            E1.play();
            break;

        case "Db1":
            var Db1 = new Audio('notes/notes_Db1.mp3');
            Db1.play();
            break;
        case "Eb1":
            var Eb1 = new Audio('notes/notes_Eb1.mp3');
            Eb1.play();
            break;
    }
